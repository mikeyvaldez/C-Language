...
int main()
{
    ...
    // this loop is counting down from 5 to 0
    for (numberOfGuesses = 5; numberOfGuesses > 0; --numberOfGuesses)
    {
        printf("\nYou have %d tr%s left.", numberOfGuesses, numberOfGuesses == 1 ? "y" : "ies");    // this print statement uses a turnary operator ? 
        printf("\nEnter a guess: ");
        scanf("%d", &guess);
        ...
        {
            printf("I said the nubmer is between 0 and 20.\n");
        }
